...
public class Main extends SlideApplication {
    ...
    public void initPresentation(Presentation presentation) {
        ...
        presentation.addSlide(new TitleSlide("VRL-Studio"));
        
        presentation.addSlide(new ImageSlide(PREFIX + "what-is-vrl.png"));
        presentation.addSlide(new ImageSlide(PREFIX + "automatic-gui-generation.png"));
        
        presentation.addSlide(new TitleSlide("Demo"));

        presentation.addSlide(new TitleSlide("Creating 3D Objects\nwith\nVRL-Studio"));
        
        presentation.addSlide(new TitleSlide("Pi on Wheels"));
